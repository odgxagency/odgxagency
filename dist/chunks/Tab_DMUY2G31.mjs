...
import { h as humanize } from './Base_CCuEFion.mjs';
...
const Accordion = ({
  ...
  return /* @__PURE__ */ jsx("div", { className: "border border-border rounded-[20px] overflow-hidden mb-4", children: /* @__PURE__ */ jsxs("div", { className: `accordion ${show && "active"} ${className}`, children: [
    /* @__PURE__ */ jsxs("button", { className: "accordion-header", onClick: () => setShow(!show), children: [
      /* @__PURE__ */ jsx("span", { dangerouslySetInnerHTML: { __html: title } }),
      /* @__PURE__ */ jsx(
        "svg",
        {
...
export { Accordion as A, Notice as N, Tabs as T, Video as V, Youtube as Y, Tab as a };
