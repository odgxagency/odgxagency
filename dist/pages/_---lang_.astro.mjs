...
import 'kleur/colors';
import { $ as $$Faq } from '../chunks/Faq_BSkzWSoi.mjs';
import { a as $$ThreeDot, $ as $$Feature } from '../chunks/Feature_BFO9S4QQ.mjs';
import { g as getLangFromUrl, m as markdownify, s as slugSelector, b as $$ImageMod, d as getListPage, e as getSinglePage, $ as $$Base, f as filteredSupportedLang } from '../chunks/Base_KJslVqZp.mjs';
import { $ as $$TitleBg } from '../chunks/TitleBg_DkA3rs7k.mjs';
import { C as Counter } from '../chunks/Counter_CYQKoyyi.mjs';
import { $ as $$Testimonial } from '../chunks/Testimonial_BQeIK5f_.mjs';
...
}, "/Users/lukasz/Desktop/Untitled/odgxagency/src/layouts/components/home/Hero.astro", void 0);
...
const $$ReasonSlide = createComponent(($$result, $$props, $$slots) => {
  ...
  ], "class:list")}> ${renderComponent($$result, "ImageMod", $$ImageMod, { "src": f.image, "width": 329, "height": 431, "alt": "reason", "class": "h-1/3 mx-auto shadow rounded-[25px] w-full p-2 border border-[#ffffff4d]" })} </div> </div>`)} </div> </div> ${renderScript($$result, "/Users/lukasz/Desktop/Untitled/odgxagency/src/layouts/components/home/ReasonSlide.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/lukasz/Desktop/Untitled/odgxagency/src/layouts/components/home/ReasonSlide.astro", void 0);
...
}, "/Users/lukasz/Desktop/Untitled/odgxagency/src/layouts/components/home/Reasons.astro", void 0);
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const planData = await getSinglePage("planSection", lang, "plan");
  ...
  const testimonial = testimonialData.length > 0 ? testimonialData[0] : null;
  return renderTemplate`${renderComponent($$result, "Base", $$Base, {}, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Hero", $$Hero, { "hero": hero })} ${renderComponent($$result2, "Feature", $$Feature, { "feature": feature })} ${renderComponent($$result2, "Video", $$Video, { "video": video })} ${renderComponent($$result2, "Reasons", $$Reasons, { "reason": reason })} ${plan && renderTemplate`${renderComponent($$result2, "Plan", null, { "plan": plan, "lang": language, "client:only": "react", "client:component-hydration": "only", "client:component-path": "@/components/pricing/Plan", "client:component-export": "default" })}`}${renderComponent($$result2, "Testimonial", $$Testimonial, { "testimonial": testimonial })} ${renderComponent($$result2, "Faq", $$Faq, {})} ` })}`;
}, "/Users/lukasz/Desktop/Untitled/odgxagency/src/pages/[...lang]/index.astro", void 0);

const $$file = "/Users/lukasz/Desktop/Untitled/odgxagency/src/pages/[...lang]/index.astro";
const $$url = "/[...lang]";
